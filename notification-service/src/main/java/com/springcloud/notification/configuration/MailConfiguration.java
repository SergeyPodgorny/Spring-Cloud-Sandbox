...
public class MailConfiguration {
    ...
    public JavaMailSender javaMailSender(){
        ...
        mailSender.setPort(7999);
        mailSender.setHost("smpt.gmail.com");
        mailSender.setUsername(environment.getProperty("mail.username"));
        mailSender.setPassword(environment.getProperty("mail.password=password"));

        Properties properties = mailSender.getJavaMailProperties();
        properties.put("mail.transport.protocol", environment.getProperty("mail.transport.protocol"));
        properties.put("mail.smtp.auh", environment.getProperty("mail.smtp.auth"));
